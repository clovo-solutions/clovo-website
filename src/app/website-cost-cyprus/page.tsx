...
export const metadata: Metadata = {
  ...
  description:
    "How much does a website cost in Cyprus? Honest pricing from €2,000 to €6,000+. No hidden fees. See what affects the price and what you actually get.",
  alternates: {
  ...
  openGraph: {
    ...
    description:
      "Transparent web design pricing for Cyprus businesses. From €2,000 for a business site to €6,000+ for full automation. See the real breakdown.",
