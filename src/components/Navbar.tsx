...
const navLinks = [
  ...
  { href: "testimonials", label: "Testimonials", num: "04" },
  { href: "projects", label: "Our Work", num: "05" },
];
...
export default function Navbar() {
  ...
  useEffect(() => {
    ...
    const SHOW_DELTA = 10; // px scrolled up before navbar reappears
