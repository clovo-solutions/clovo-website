...
const plans = [
  {
    ...
    benefits: [
      ...
      "SEO foundations so clients find you — not your competitors",
  ...
  },
  {
    ...
    benefits: [
      ...
      "Appointment scheduling that runs itself — with built-in confirmations and reminders to reduce no-shows.",
      "Lead capture systems connected to a CRM — so you can track, manage, and respond to every opportunity in one place.",
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-white/35 text-lg max-w-2xl mx-auto leading-relaxed">
            Every package is tailored to your business. Pick the level that
        ...
        >
          ...
          project-based — no hidden fees, no recurring charges unless you choose
          ongoing support.
        </motion.p>
      </div>
    </section>
...
//           <span
//             className={`font-display text-lg font-semibold ${
//               plan.featured ? "text-accent" : "text-white/60"
//             }`}
//           >
//             {plan.price}
//           </span>
...
//               <div
//                 className={`w-5 h-5 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5 ${
//                   plan.featured ? "bg-accent/[0.12]" : "bg-white/[0.04]"
//                 }`}
//               >
//                 <svg width="10" height="10" viewBox="0 0 10 10" fill="none">
//                   <path
//                     d="M2 5.5l2 2L8 3"
//                     stroke={plan.featured ? "#01D957" : "#ffffff50"}
//                     strokeWidth="1.5"
//                     strokeLinecap="round"
//                     strokeLinejoin="round"
//                   />
...
//           <p
//             className={`text-xs leading-relaxed ${
//               plan.featured ? "text-accent/70" : "text-white/30"
//             }`}
//           >
//             <span
//               className={`font-semibold ${
//                 plan.featured ? "text-accent/90" : "text-white/50"
//               }`}
//             >
//               Outcome:
//             </span>{" "}
